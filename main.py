...
if __name__ == '__main__':
    class Ralph(discord.Client):
        ...
        async def on_ready(self):
            try:
                ...
                synced = await bot.sync(guild=discord.Object(id=521077625519603712))
    ...
    @bot.command(name='counter', description='Get unit counter',
    ...
    @bot.command(name='build-order', description='Get build order',
                 guild=discord.Object(id=521077625519603712))
    ...
    async def self(interaction: discord.Interaction, types: discord.app_commands.Choice[str]):
        response = responses.get_build_order_response(types.value)
    ...
    @bot.command(name='civ', description='Get civ data',
                 guild=discord.Object(id=521077625519603712))
    ...
    @bot.command(name='join', description='Join voice channel author is in',
                 guild=discord.Object(id=521077625519603712))
